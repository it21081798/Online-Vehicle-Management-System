...
<head>
	...
	div.button-2{
		...
		margin-bottom: 25px;
		border-radius: 15px;
		background-color: rgba(223, 245, 252, 0.5);
		top: 40%;
	}
...
<div>
	<img src="images/login_selection.jpg" alt="Background" width="100%">

	<div class="button-2">
		<a href="../pasindu/driverLogin.php"><button type="submit" class="login-as-btn">Login as Driver</button> </a> <br> <br>
		<h1 class="or">OR</h1>
		<a href="../userprofile/userLogin.php"><button type="submit" class="login-as-btn">Login as User</button> </a>
	</div>
</div>
