<?php
require 'updateprofileconfig.php';
//session_start();
...
<div class="header">
    ...
    <div class="all">
        <form method="POST">
            ...
            First Name :
            <input type="text" class="edit" name="fName" placeholder="First Name" required> <br><br>

            Last Name :
            <input type="text" class="edit" name="lName" placeholder="Last Name" required> <br><br>

            Mobile Number : 
            <input type="number" class="edit" name="mNo" placeholder="Mobile" pattern="[0-9] {10}" required> <br><br>

            Address :
            <textarea rows="5" cols="40" name="address" class="edit"  required> </textarea><br><br>

            Date of Birth :
            <input type="date" class="edit" name="dob" placeholder="Date of Birth" required> <br><br><br>

            E-Mail : 
            <input type="email" class="edit" name="email" placeholder="E-Mail"> <br><br><br>
