...
<body>
	...
	<div class="header">
		...
		<li  class="menu1"><a href = "../aboutus/AboutUS.php" > About Us</a></li>
        <li  class="menu1"><a href = "../news/news.php" > News</a></li>
		<li  class="menu1"><a href = "../career/careerh" > Career</a></li>
		<li  class="menu1"><a href = "../package/package.php" > Packages</a></li>
		<li  class="menu1"><a href = "../ride/Ride.php" >Ride </a></li>
		<li  class="menu1"><a href = "../home/home.php" > Home</a></li>

	</div>

	<br>
	<div class="card">
	<form onsubmit="return checkPassword1 ()"  action="con1.php"   method="post"  >
		
			
				
			<h2 class="subhead">User Registration</h2><br><br>
			...
			<input type="password" name="password1" class="class1" id="pw1" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{10,}" title="Must Contain At Least One Number And One Uppercase And Lowercase Letter,And At Least 10 Or More Charactters"><br><br>
		    
			<h2 class="field">Repeat Password:</h2><br>
			<input type="password" name="password2" class="class1" id="pw2" >
			
			<br>
			
			<input type="checkbox" onchange="AcceptTerms1()" id="chkTerms1" class="field">Accept Privacy Policy & Terms.<br>
			<br><br>
			
			<input type="submit" name="btnSub1" id="subReg1" class="register" value="Register" disabled >
            <p><b>Already have a Account?</b><a href="../userprofile/userLogin.php">Login</a></p>
